...
- [ ] CI is green on `main` (lint, test, build pass — see [Actions](https://github.com/vvsynapse/agent-sdk-go/actions))
...
The workflow runs automatically when the tag is pushed. Check [Actions](https://github.com/vvsynapse/agent-sdk-go/actions) for status.
...
- **Go modules:** The tag becomes the module version for `go get github.com/vvsynapse/agent-sdk-go@v1.0.0`.
