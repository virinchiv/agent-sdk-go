...
Please report security vulnerabilities by opening a [GitHub Security Advisory](https://github.com/vvsynapse/temporal-agents-go/security/advisories/new). Do not open a public issue for security vulnerabilities.
